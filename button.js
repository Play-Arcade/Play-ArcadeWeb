...
var app = new PIXI.Application({ width: 800, height: 600, resizeTo: window });
...
buttonvi.tap = noop;
buttonvi.mouseover = function() {
  app.stage.addChild(messagevi);
};
buttonvi.mouseout = function() {
  app.stage.removeChild(messagevi);
};
buttonvi.click = function() {
  app.stage.removeChild(boov);
  app.stage.addChild(booov);
};
